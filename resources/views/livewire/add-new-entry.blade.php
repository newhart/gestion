            ...
            <div class="col-md-9">
                ...
                <div class="flex justify-between py-3">
                    <div class="d-flex flex-column flex-root">
                        ...
                        <span class="opacity-70">{{ \Carbon\Carbon::parse($bonde->created_at)->format('M d, Y')}}</span>
                    </div>
                    <div class="d-flex flex-column flex-root">
                    ...
                    <div class="d-flex flex-column flex-root">
                        ...
                        @if(!$bonde->status)
                            <span class="opacity-70  bg-gray-500 text-white w-[100px] px-3 pl-7 rounded-xl py-2">En attente</span>
                        @else
                            <span class="opacity-70  bg-green-400 text-white w-[100px] px-3 pl-7 rounded-xl py-2">Valider</span>
                        @endif
                    </div>
            ...
            <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
                <div class="col-md-9">
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary font-weight-bold" wire:click.prevent="click">Valider</button>
                    </div>
                </div>
            </div>
            <!-- end: Invoice action-->
