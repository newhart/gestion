        ...
        <div id="container" class="w-full">
            <div class="px-40 pt-20" id="test">
                ...
                <div class="d-flex w-full flex-row-reverse">
                    <a href="" data-toggle="modal" data-target="#exampleModalLong" class="text-gray-800" id="text-ajout">Ajouter une autre  produit</a>
                </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($data['contents'] as $key => $content)
                                <tr class="font-weight-boldest {{$key !== 0 ?? 'border-bottom-0' }}">
                                    ...
                                    <td class="text-danger pr-0 pt-7 text-right">{{$content['qty'] *  $content['price']}} Ar</td>
                                </tr>
